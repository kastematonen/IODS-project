...
biplot(pca_human, choices = 1:2, cex = c(0.8, 1)) # koko havainnoille & pc-loadingseille
biplot(pca_human, choices = 1:2, cex = c(0.8, 1), col = c("grey40", "deeppink2")) # haainnot harmaalla, loadingsit pinkillä
...
plot(mca, invisible=c("ind"), graph.type = "classic", habillage = "quali") # saman muuttujan eri tasot samalla värillä habillagella
