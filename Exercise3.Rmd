...
g2 <- ggplot(data = alc, aes(x = high_use)) + geom_bar() + facet_wrap("sex")
g2
```
...
g2 <- ggplot(alc, aes(x = high_use, y = absences, col=sex)) + geom_boxplot() + ylab("grade") + ggtitle("Student absences by alcohol consumption and sex")
g2
