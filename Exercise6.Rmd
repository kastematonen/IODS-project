...
BPRSL <- BPRSL %>%
  group_by(week) %>%
  mutate(stdbprs = (bprs - mean(bprs))/sd(bprs)) %>% # did this do anything? 
  ungroup()
...
# BPRSL8S1 <- BPRSL8S[BPRSL8S$mean < 60,]
